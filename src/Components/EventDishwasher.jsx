    ...
    return (
        <section className="relative py-20 bg-gray-900 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="inline-flex items-center justify-center p-3 mb-6 rounded-full bg-gray-800 border border-gray-700 shadow-lg animate-bounce-slow">
                    <FaGlassCheers className="text-green-400 text-xl mr-2" />
                    <span className="text-gray-300 font-medium tracking-wide text-sm uppercase">
                        Party & Event Support
                    </span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button
                        onClick={openModal}
                        className="group relative px-8 py-4 bg-green-600 hover:bg-green-500 text-white font-bold rounded-full shadow-lg hover:shadow-green-500/30 transition-all duration-300 transform hover:-translate-y-1"
                    >

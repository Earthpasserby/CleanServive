    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className={`relative w-full max-w-2xl bg-slate-900 text-white rounded-xl shadow-2xl flex flex-col max-h-[90vh] border border-slate-800 transition-all duration-300 transform ${open ? "scale-100 opacity-100 translate-y-0" : "scale-95 opacity-0 translate-y-4"
                        }`}
                >
                    <div className="flex items-center justify-between p-6 border-b border-slate-800 shrink-0">
                        <div>
                            <h3 className="text-xl font-bold text-white">Event Cleaning Quote</h3>
                            <p className="text-sm text-slate-400 mt-1">Let us handle the mess at your next event</p>
                        </div>
                        <button
                            type="button"
                            onClick={() => setOpen(false)}
